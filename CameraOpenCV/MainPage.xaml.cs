...
namespace SDKTemplate
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void ScenarioControl_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            this.NotifyUser("Scanning ...", NotifyType.StatusMessage);
        ...
        public void NotifyUser(string strMessage, NotifyType type)
        {
            ...
            {
                this.UpdateStatus(strMessage, type);
            }
            else
            {
                var task = this.Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () => this.UpdateStatus(strMessage, type));
            }
        }
        ...
        private void UpdateStatus(string strMessage, NotifyType type)
        {
            ...
            var peer = FrameworkElementAutomationPeer.FromElement(this.StatusBlock);
            if (peer != null)
            {
