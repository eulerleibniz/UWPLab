...
namespace SDKTemplate
{
    ...
    class FrameRenderer
    {
        ...
        public FrameRenderer(Image imageElement)
        {
            ...
            this._imageElement.Source = new SoftwareBitmapSource();
        }
        ...
        public void ProcessFrame(MediaFrameReference frame)
        {
            ...
            this.RenderFrame(softwareBitmap);
        }
        ...
        public void RenderFrame(SoftwareBitmap softwareBitmap)
        {
            if (softwareBitmap != null)
            {
                ...
                softwareBitmap = Interlocked.Exchange(ref this._backBuffer, softwareBitmap);

                // UI thread always reset _backBuffer before using it.  Unused bitmap should be disposed.
                softwareBitmap?.Dispose();

                // Changes to xaml ImageElement must happen in UI thread through Dispatcher
                var task = this._imageElement.Dispatcher.RunAsync(CoreDispatcherPriority.Normal,
                    async () =>
                    {
                        ...
                        while ((latestBitmap = Interlocked.Exchange(ref this._backBuffer, null)) != null)
                        {
                            var imageSource = (SoftwareBitmapSource)this._imageElement.Source;
